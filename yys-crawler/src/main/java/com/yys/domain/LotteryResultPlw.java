 ...
 */
@Entity
@Table(name = "t_lottery_result_plw")
public class LotteryResultPlw {
    @Id
    ...
    private Integer prize_num;       //直选-中奖注数,每注金额100000.00


    public LotteryResultPlw() {
    }

    public LotteryResultPlw(String lottery_no, String lottery_red, String lottery_blue, String lottery_date, String lottery_exdate, String lottery_sale_amount, String lottery_pool_amount, Integer prize_num) {
