 ...
 */
@Entity
@Table(name = "t_lottery_result_qxc_prize")
public class LotteryResultQxcPrize {
    @Id
    ...
    public LotteryResultQxcPrize() {
    }

    public LotteryResultQxcPrize(String lottery_no, String prize_name, String prize_num, String prize_amount, String prize_require) {
