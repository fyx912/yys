...
public class LotteryResultQclPrize {
    @Id
    ...
    public LotteryResultQclPrize() {
    }

    public LotteryResultQclPrize(String lottery_no, String prize_name, String prize_num, String prize_amount, String prize_require) {
