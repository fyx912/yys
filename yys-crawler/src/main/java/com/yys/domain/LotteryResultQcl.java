 ...
 */
@Entity
@Table(name = "t_lottery_result_qcl")
public class LotteryResultQcl {
    @Id
    ...
    public LotteryResultQcl() {
    }

    public LotteryResultQcl(String lottery_no, String lottery_red, String lottery_blue, String lottery_date, String lottery_exdate, String lottery_sale_amount, String lottery_pool_amount) {
