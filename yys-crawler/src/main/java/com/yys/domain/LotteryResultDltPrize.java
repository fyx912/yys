 ...
 */
@Entity
@Table(name = "t_lottery_result_dlt_prize")
public class LotteryResultDltPrize {
    @Id
    ...
    public LotteryResultDltPrize() {
    }

    public LotteryResultDltPrize(String lottery_no, String prize_name, String prize_num, String prize_amount, String prize_require) {
