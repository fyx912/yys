 ...
 */
@Entity
@Table(name = "t_lottery_result_fcsd")
public class LotteryResultFcsd {
    @Id
    ...
    public LotteryResultFcsd() {
    }

    public LotteryResultFcsd(String lottery_no, String lottery_red, String lottery_blue, String lottery_date, String lottery_exdate, String lottery_sale_amount, String lottery_pool_amount, Integer z3_prize_num, Integer g3_prize_num, Integer g6_prize_num) {
